...
class THESPELLPLANES_API UGearItem : public UEquipableItem
{
	GENERATED_BODY()
...
public:
	...
	virtual bool Equip(class ASpellPlanesCharacter* Character) override;
	virtual bool UnEquip(class ASpellPlanesCharacter* Character) override;
